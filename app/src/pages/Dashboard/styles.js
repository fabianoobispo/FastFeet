...
export const OrdersHeaderLinkText = styled.Text`
  color: ${props => (props.active ? '#087edd' : '#999999')};
  font-size: 13px;
  font-weight: bold;
  padding: 10px;
...
export const OrderText = styled.Text`
  color: ${props => (props.canceled ? '#E74040' : '#087edd')};
  font-size: 14px;
  font-weight: bold;
  margin-left: 10px;
`;
...
export const ProgressBar = styled.View`
  ...
  height: 2px;
  width: 83%;
  background: ${props => (props.canceled ? '#E74040' : '#087edd')};
`;
